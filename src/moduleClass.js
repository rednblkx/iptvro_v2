...
var Module = (function () {
    function Module(MODULE_ID, hasLive, hasVOD, chList, qualitiesList) {
        ...
        this.initializeConfig = function initializeConfig() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    (0, fs_1.writeFile)("".concat(__dirname, "/../modules/").concat(MODULE_ID, ".json"), JSON.stringify(config, null, 2), function () {
                        console.log("".concat(MODULE_ID, " config file created"));
                        return config;
                    });
                    return [2];
                });
